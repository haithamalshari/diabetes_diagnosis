...
# Build the model
classifier = cat.CatBoostClassifier(verbose=0, boosting_type = 'Plain',rsm=0.1,n_estimators = 50,
                                      learning_rate = 0.17, leaf_estimation_iterations = 2,
...
# Train the model
classifier.fit(train_feats, train_labels,cat_features=cats)

# Save the model to file
pkl.dump(classifier, open("cat_model.pickle.dat", "wb"))

# Load the model from file
classifier = pkl.load(open("cat_model.pickle.dat", "rb"))
