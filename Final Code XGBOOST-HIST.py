...
# Build the model
classifier = xgb.XGBClassifier(n_estimators = 100, learning_rate = 0.16 , max_depth = 3, min_child_weight = 0.6, 
                              colsample_bytree = 1, subsample = 1, scale_pos_weight =ratio, tree_method ='hist')

# Train the model
classifier.fit(train_feats, train_labels)

# Save the model to file
pkl.dump(classifier, open("xgb_model_hist.pickle.dat", "wb"))

# Load the model from file
classifier = pkl.load(open("xgb_model_hist.pickle.dat", "rb"))
